...
class ReceivingDisplacementCommandTest {
    ...
    fun should_increase_Y_when_facing_north_and_moves_forward() {
        ...
        //Then
        val expectedRover = RoverBuilder.aNasaMarsRover().at(2, 3).pointing("N").build()
    ...
    fun should_increase_X_when_facing_east_and_moves_forward() {
        //Given
        val startRover = RoverBuilder.aNasaMarsRover().at(2, 2).pointing("E").build()
        //When
        startRover.sendCommands("f")
        //Then
        val expectedRover = RoverBuilder.aNasaMarsRover().at(3, 2).pointing("E").build()
        assertEquals(expectedRover, startRover)
    }
    ...
    fun should_decrease_Y_when_facing_south_and_moves_forward() {
        //Given
        val startRover = RoverBuilder.aNasaMarsRover().at(2, 2).pointing("S").build()
        //When
        startRover.sendCommands("f")
        //Then
        val expectedRover = RoverBuilder.aNasaMarsRover().at(2, 1).pointing("S").build()
        assertEquals(expectedRover, startRover)
    }
    ...
    fun should_decrease_X_when_facing_west_and_moves_forward() {
        //Given
        val startRover = RoverBuilder.aNasaMarsRover().at(2, 2).pointing("W").build()
        //When
        startRover.sendCommands("f")
        //Then
        val expectedRover = RoverBuilder.aNasaMarsRover().at(1, 2).pointing("W").build()
        assertEquals(expectedRover, startRover)
    }
    ...
    fun should_decrease_Y_when_facing_north_and_moves_backward() {
        ...
        //Then
        val expectedRover = RoverBuilder.aNasaMarsRover().at(2, 1).pointing("N").build()
        assertEquals(expectedRover, startRover)
    }
    ...
    fun should_decrease_X_when_facing_east_and_moves_backward() {
        ...
        startRover.sendCommands("b")
        //Then
        val expectedRover = RoverBuilder.aNasaMarsRover().at(1, 2).pointing("E").build()
        assertEquals(expectedRover, startRover)
    }
    ...
    fun should_increase_Y_when_facing_south_and_moves_backward() {
        ...
        startRover.sendCommands("b")
        //Then
        val expectedRover = RoverBuilder.aNasaMarsRover().at(2, 3).pointing("S").build()
        assertEquals(expectedRover, startRover)
    }
    ...
    fun should_increase_X_when_facing_west_and_moves_backward() {
        ...
        startRover.sendCommands("b")
        //Then
        val expectedRover = RoverBuilder.aNasaMarsRover().at(3, 2).pointing("W").build()
        assertEquals(expectedRover, startRover)
    }
}